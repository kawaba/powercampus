...
public class Parameter {
	...
	public Parameter(String fname) throws FileNotFoundException,IOException {
		paramConst(fname,"=");
	}
	public Parameter(String fname, String ds) throws FileNotFoundException,IOException {
		paramConst(fname,ds);
	}
	//
	public void paramConst(String fname, String ds) throws FileNotFoundException,IOException {
	...
	public String	property(String key)	{ return Gear.strHash(tbl,key,null);}
	public String	get(String key)			{ return Gear.strHash(tbl,key,null);}
}
