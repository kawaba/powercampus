 ...
 *
 */
public class KamokuConvert_save extends SuperPlayer  implements KamokuVar{
	...
	public	KamokuConvert_save(String szDB, String teUid, String tname, PrintWriter out, Hashtable ht, Param para, Database db){
