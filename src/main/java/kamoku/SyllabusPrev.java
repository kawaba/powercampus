...
*
	...
	# ##################
	#
	<program $kamoku.SyllabusPrev>
		<dispatch  html=SyllabusPrev.html  number=1135  class=kamoku.SyllabusPrev />
		<variable>
...
*/
public class SyllabusPrev extends SuperPlayer{
	...
	public	SyllabusPrev(){
		super();
		if(LOG.fa) LOG.println("■ SyllabusPrev #コンストラクタ");
	}	
	...
	public	String	dispatch(){
		if(LOG.fa) LOG.println("■ SyllabusPrev #dispatch()");
		//
	...
	public  void	display(boolean editmode){
		if(LOG.fa) LOG.println("■ SyllabusPrev #display()");
	...
	public	void	write(String key){
		if(LOG.fa) LOG.println("■ SyllabusPrev #write()");
	 ...
	 */
	void	line(){
		if(LOG.fa) LOG.println("■ SyllabusPrev #line()");
	...
	void	kamokuDsp(){
		if(LOG.fa) LOG.println("■ SyllabusPrev #kamokuDsp()");
	 ...
	 */
	void	items(){
		if(LOG.fa) LOG.println("■ SyllabusPrev #items()");
	...
	void	printList(KamokuParser	kp){
		if(LOG.fa) LOG.println("■SyllabusPrev #printList()");		
	...
	KamokuParser	getKamokuParser(String	xml, KamokuDefRecord kdrec){
		if(LOG.fa) LOG.println("■ SyllabusPrev #getKamokuParser()");
	...
	void	alart(KamokuDefRecord kdrec){
		if(LOG.fa) LOG.println("■ SyllabusPrev #alart()");
