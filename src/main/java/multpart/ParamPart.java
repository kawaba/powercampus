...
/*
   日本語対応に変更した。 2003.2.11 Takashi KAWABA
　具体的には、
　　ParamPart.java でエンコーディングを ISO-8859-1 から JISAutoDetect に変更し、
　　CP932 を適用するようにした。
　　//
      public String getStringValue() 
          throws UnsupportedEncodingException {
        //return getStringValue( "ISO-8859-1" );
        return Cp932.toJIS( getStringValue( "JISAutoDetect" ) );
    }
    //
*/
...
public class ParamPart extends Part {
  ...
  public String getStringValue() 
      throws UnsupportedEncodingException {
    //return getStringValue( "ISO-8859-1" );
    return Cp932.toJIS( getStringValue( "JISAutoDetect" ) ); // 2003.2.11 日本語対応化
  }
