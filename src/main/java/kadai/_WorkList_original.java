 ...
 * 
	...
	<program $kadai.WorkList>
		...
		<variable>
		  ...
		  <accept    CMD    kadai_key past_kadai_seq />
		  <keep      />
 ...
 *
 */
public class _WorkList_original extends SuperPlayer {
	...
	void 	updateSecKadaiField(){
		...
		for(int i=0; i<n; i++){
			...
			if( cb_value.equals("YES")){
				...
				kadailist.add(kadaiDef.kadai_key(i));	// // 第i番目の課題キーを取り出す
			}
		}
