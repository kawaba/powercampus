...
import java.util.*;
//
public interface AdditionalPrint {
	//
	/* ----------------------------------------------------------------------------------
	■ write() メソッド --- 処理の挿入
	　　　指示された処理を行う.
	...
	*/
	void	write(String key,StringBuffer out,Hashtable htb);
	...
	*/
	void	write(String key,StringBuffer out,Hashtable htb,StringBuffer ext);
	...
	*/
	void	blockWrite(String key,StringBuffer out,Hashtable htb,StringBuffer ext);
