...
Note : The Microsoft ・ｮ Windows NT ・ｮ Server 4.0 Resource Kit contains REG.EXE. In Windows 2000 and later REG.EXE is a native command. The REG utility can be used to write values in the registry (reg add /? for more infos). 
